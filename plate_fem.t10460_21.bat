...
set MSC_AUTH=EDU
set MSC_BASE=c:/msc.software/msc_nastran_student_edition/2014/nastran
set MSC_DBS=c:/scratch/plate_fem.T10460_21
...
@rem
set /a f98 = 0
call :get_file_size  "%sdirnt%\plate_fem.T10460_21.f98"
if /i %FILE_SIZE% gtr 0 set /a f98 = 1
set /a f99 = 0
call :get_file_size  "%sdirnt%\plate_fem.T10460_21.f99"
...
if /i %i% neq 0 (
   ...
   if "%ferr%" == "" (
      if /i %f98% neq 0 (
         if /i %f99% neq 0 copy /f /y "%sdirnt%\plate_fem.T10460_21.f99"+"%sdirnt%\plate_fem.T10460_21.f98" "%outnt%.acms_out"
         if /i %f99% equ 0 copy /f /y "%sdirnt%\plate_fem.T10460_21.f98" "%outnt%.acms_out"
      ) else (
         copy /f /y "%sdirnt%\plate_fem.T10460_21.f99" "%outnt%.acms_out"
      )
   )
)
@rem
...
for %%f in ("%sdirnt%\plate_fem.T10460_21.*") do call :delete_job_file "%%f"
